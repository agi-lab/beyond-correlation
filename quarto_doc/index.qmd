...
set.seed(123)
HellCor::HellCor(worlddemographics$Birth.Rate.Pop, worlddemographics$Death.Rate.Pop, pval.comp = TRUE)

set.seed(123)
dcov::dcor.test(worlddemographics$Birth.Rate.Pop, worlddemographics$Death.Rate.Pop)
```
...
```{r}
cor(dat$X3, dat$Y)
dcov::dcor(cbind(dat$X1,dat$X2),Y)

set.seed(123)
dcov::dcor.test(cbind(dat$X1,dat$X2),Y)
```
